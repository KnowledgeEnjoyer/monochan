...
INSERT INTO Threads (Board, ThreadTitle, ThreadBody, ThreadImg, CreatedAt, BumpedAt) VALUES 
  ("b", "TESTANDO TITULO DE THREAD 1", "TESTANDO THREAD BODY 1", "TESTE IMAGE 1", NOW(), NOW()),
  ("b", "TESTANDO TITULO DE THREAD 2", "TESTANDO THREAD BODY 2", "TESTE IMAGE 2", NOW(), NOW()),
  ("b", "TESTANDO TITULO DE THREAD 3", "TESTANDO THREAD BODY 3", "TESTE IMAGE 3", NOW(), NOW());
